...
| - Rule_Chain_mqtt_router.json <br> - mqtt_profile_router.json | Push - MQTT router: Receive via MQTT, push to Watmonitor via HTTPS POST | [MQTT router ThingsBoard](https://medium.com/@your-iot/mqtt-router-via-thingsboard-watmonitor-5f193d6ea2ad) |
