...
//MSB format required
//Get these keys from TTN, DEVADDR can be any u want (4 bytes) HEX format
static const PROGMEM u1_t NWKSKEY[16] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
static const u1_t PROGMEM APPSKEY[16] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
static const u4_t DEVADDR = 0x00000000; //Device address 32-bit

//Ultrasonic sitance sensor HC-SR04 / JSN-SR04T
...
const lmic_pinmap lmic_pins = {
  ...
  .rst = 14, //reset pin (if in use), use LMIC_UNUSED_PIN if RST not connected
...
void do_send(osjob_t* j) {
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    // Pass the JSON payload to LMIC_setTxData2
    LMIC_setTxData2(1, (uint8_t*)jsonString, jsonLength, 0);
