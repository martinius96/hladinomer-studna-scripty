/*|-----------------------------------------------------------------|*/
/*|Project: Water level monitor - HTTPS - ULP - Rpi Pico W (RP2040) |*/
/*|Project info: https://your-iot.github.io/Watmonitor/             |*/
/*|Test web interface: https://hladinomer.eu/?lang=en               |*/

// Simulate project at: https://wokwi.com/projects/445828206402304001
...
float measureDistance() {
  ...
  for (int i = 0; i < samples; i++) {
    ...
    Serial1.println(" cm");
    sum += distance_cm;
    delay(60);  // malá pauza medzi meraniami
  }
...
void setup() {
  ...
  Serial1.print("Arduino Core Version: ");
  Serial1.println(ARDUINO);
  Serial1.print("CPU Frequency: ");
  Serial1.print(F_CPU / 1000000);
  Serial1.println(" MHz");
  Serial1.print("SDK Version: ");
  Serial1.println(PICO_SDK_VERSION_STRING);
  Serial1.println("---------------------");
  pinMode(TRIG_PIN, OUTPUT);
  pinMode(ECHO_PIN, INPUT);
  Serial1.println("Set distance via HC-SR04 sensor, you have 5 seconds");
  delay(5000);
  connectWiFi();
}
