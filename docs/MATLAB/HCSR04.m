...
hlbka8 = 3.5:0.01:4;
hlbka9 = 4:0.01:4.5;
priemer1 = hlbka1*tan(0.1316525)
priemer2 = hlbka1*tan(-0.1316525)
priemer3 = hlbka2*tan(0.1316525)
priemer4 = hlbka2*tan(-0.1316525)
priemer5 = hlbka3*tan(0.1316525)
priemer6 = hlbka3*tan(-0.1316525)

priemer7 = hlbka4*tan(0.1316525)
priemer8 = hlbka4*tan(-0.1316525)

priemer9 = hlbka5*tan(0.1316525)
priemer10 = hlbka5*tan(-0.1316525)

priemer11 = hlbka6*tan(0.1316525)
priemer12 = hlbka6*tan(-0.1316525)

priemer13 = hlbka7*tan(0.1316525)
priemer14 = hlbka7*tan(-0.1316525)

priemer15 = hlbka8*tan(0.1316525)
priemer16 = hlbka8*tan(-0.1316525)

priemer17 = hlbka9*tan(0.1316525)
priemer18 = hlbka9*tan(-0.1316525)
...
title('DetekËn· charakteristika senzora HC-SR04')
grid minor
xlabel('Vzdialenosù (m)') 
